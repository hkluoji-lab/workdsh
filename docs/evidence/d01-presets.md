...
- 官方依据：[Skills](../dsh-v0.1.7-alpha.1/subsystems/skills.zh.md) 与 [Core/preset](../dsh-v0.1.7-alpha.1/subsystems/core.zh.md)；发布包 `dsh-agent-presets`、`dsh-skill`、`dsh-skill-filesystem` 均为 `0.1.5-rc.1`。使用包根公开导出、原生选择 UI、已观察到的 `agentPresets/select` 与 `skills/list` Remote。
...
- 官方依据：本仓库 `docs/dsh-v0.1.7-alpha.1/subsystems/skills.zh.md`；发布包 scope 与 skill 的公开声明。
