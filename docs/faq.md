...
本页回答安装、平台、运行环境和插件的常见问题。实际可下载的平台和版本以 [GitHub Releases](https://github.com/techflag/workdsh/releases) 中附带的安装文件为准。
...
从 [GitHub Releases](https://github.com/techflag/workdsh/releases) 下载附有安装文件的版本。遇到问题时先查看[用户指南的排查部分](user-guide.md#排查)，仍无法解决再提交 [GitHub Issue](https://github.com/techflag/workdsh/issues/new/choose)，并附上操作系统、应用版本、复现步骤和错误信息。
