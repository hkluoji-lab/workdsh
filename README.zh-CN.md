...
| 专家 | `workdsh-plugin-experts@0.1.0-alpha.4` | [专家 `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-experts-0.1.0-alpha.4.tgz) · [发布页](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | 专家定义、已审阅修订及其与官方 DSH Team 运行时的组合。 |
| 连接器 | `workdsh-plugin-connectors@0.1.0-alpha.1` | [连接器 `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-connectors-0.1.0-alpha.1.tgz) · [项目发行](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | 多 stdio/HTTP MCP 实例、官方凭据存储、健康与工具发现、按对话隔离工具。 |
| 工作动态 | `workdsh-plugin-activity@0.1.0-alpha.3` | [动态 `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-activity-0.1.0-alpha.3.tgz) · [发布页](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | 显示任务、技能和专家团队工作状态。 |
...
| WorkDSH 展示组合 | `workdsh-bundle@0.1.0-alpha.45` | [展示 `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-bundle-0.1.0-alpha.45.tgz) · [项目发行](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | 可选品牌、主题与工作台组合；功能插件按需独立安装。 |
...
完整产品请把[项目发行 `v0.1.0-alpha.4`](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4)的全部资产下载到同一目录。停止目标 Profile，进入下载目录后使用带校验的安装器：
