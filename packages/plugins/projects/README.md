...
「从模板创建」内置 15 个场景模板（产品需求全流程、市场调研与竞品分析、团队知识库、项目交付、Bug 跟踪/测试验收、内容营销与社媒运营、客户跟进与商机管理、数据分析与经营报表、活动策划与执行、招投标与解决方案、招聘与人才选拔、培训与课程开发、财务预算与成本核算、品牌与视觉设计、网站建设与 SEO 增长）。模板是纯预填数据：只预填项目名称、一句场景描述与初始指令，创建后可编辑；不自动执行、不预先绑定专家或技能，也不改变项目权限语义。
