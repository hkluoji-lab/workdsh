...
const css = `${modalCss}
.wd-connector-picker{position:relative;display:flex;align-items:center}.wd-connector-trigger{display:flex;align-items:center;gap:7px;max-width:190px;height:36px;padding:0 9px;border:0;border-radius:10px;background:transparent;color:var(--dsw-alias-label-secondary);font-size:13px;cursor:pointer}.wd-connector-trigger:hover,.wd-connector-trigger[aria-expanded="true"]{background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary)}.wd-connector-trigger .trigger-icon{display:grid;place-items:center;width:22px;height:22px;flex:none;border-radius:7px;background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-secondary)}.wd-connector-trigger .trigger-icon.connected{background:linear-gradient(145deg,#146c7c,#11b7c8);color:white;font-weight:700}.wd-connector-trigger .trigger-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:500}.wd-connector-trigger .trigger-count{color:var(--dsw-alias-label-caption);font-size:11px}
.wd-connector-popover{position:absolute;z-index:90;left:0;bottom:calc(100% + 10px);width:336px;max-height:min(430px,60vh);overflow:auto;padding:8px;border:0;border-radius:15px;background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-elevation-prominent);font:14px/20px "PingFang SC","Microsoft YaHei",sans-serif}.wd-connector-popover *{box-sizing:border-box}.wd-connector-popover .picker-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;width:100%;min-height:54px;padding:5px;border-radius:10px}.wd-connector-popover .picker-row:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.wd-connector-popover .picker-main{display:grid;grid-template-columns:38px minmax(0,1fr);align-items:center;gap:10px;min-width:0;padding:3px;border:0;background:transparent;color:inherit;text-align:left;cursor:pointer}.wd-connector-popover .picker-mark,.connector-picker-detail .picker-mark{display:grid;place-items:center;width:38px;height:38px;border-radius:10px;background:linear-gradient(145deg,#146c7c,#11b7c8);color:#fff;font-weight:700;text-transform:uppercase}.wd-connector-popover .picker-copy{min-width:0}.wd-connector-popover .picker-copy strong,.wd-connector-popover .picker-copy small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.wd-connector-popover .picker-copy strong{font-size:14px;font-weight:600}.wd-connector-popover .picker-copy small{margin-top:2px;color:var(--dsw-alias-label-caption);font-size:11px}.wd-connector-popover .picker-action{min-width:52px;padding:6px 8px;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary);cursor:pointer}.wd-connector-popover .picker-action:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.wd-connector-popover .picker-action.ready{color:var(--dsw-alias-state-success-primary)}.wd-connector-popover .picker-action.offline{color:var(--dsw-alias-state-error-primary)}.wd-connector-popover .picker-action.discovering{color:var(--dsw-alias-state-warn-primary)}.wd-connector-popover .picker-empty{padding:28px 12px;text-align:center;color:var(--dsw-alias-label-caption)}.wd-connector-popover .manage{display:flex;align-items:center;gap:8px;width:100%;margin-top:6px;padding:10px 9px 5px;border:0;border-top:.5px solid var(--dsw-alias-border-l1);background:transparent;color:var(--dsw-alias-label-secondary);text-align:left;cursor:pointer}.wd-connector-popover .manage:hover{color:var(--dsw-alias-label-primary)}
.wd-dialog.connector-picker-detail{width:min(620px,calc(100vw - 48px));padding:26px}.connector-picker-detail .picker-detail-hero{display:grid;grid-template-columns:52px minmax(0,1fr);gap:15px;align-items:center;padding-right:44px}.connector-picker-detail .picker-mark{width:52px;height:52px;border-radius:14px;font-size:21px}.connector-picker-detail h2{margin:0 0 3px;font-size:21px}.connector-picker-detail .detail-state{color:var(--dsw-alias-label-caption);font-size:12px}.connector-picker-detail .detail-description{margin:20px 0;color:var(--dsw-alias-label-secondary);line-height:1.7}.connector-picker-detail .detail-tools{max-height:210px;overflow:auto;padding:15px;border:.5px solid var(--dsw-alias-border-l2);border-radius:11px;background:var(--dsw-alias-bg-layer-1)}.connector-picker-detail .detail-tools strong{display:block;margin-bottom:8px}.connector-picker-detail code{display:block;margin:5px 0;overflow:hidden;text-overflow:ellipsis;color:var(--dsw-alias-label-primary-bluish);font:12px/18px ui-monospace,SFMono-Regular,Menlo,monospace}.connector-picker-detail .detail-error{margin:12px 0 0;color:var(--dsw-alias-state-error-primary);font-size:12px}.connector-picker-detail .detail-actions{display:flex;justify-content:flex-end;gap:9px;margin-top:18px}.connector-picker-detail .detail-actions button{min-height:38px;padding:7px 14px;border:.5px solid var(--dsw-alias-border-l3);border-radius:9px;background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);cursor:pointer}.connector-picker-detail .detail-actions .primary{background:var(--dsw-alias-button-primary-fill);border-color:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-inverted);font-weight:600}
