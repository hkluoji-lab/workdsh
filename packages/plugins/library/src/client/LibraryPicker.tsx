...
const css = `.wd-library-picker-trigger{display:grid;place-items:center;width:36px;height:36px;padding:0;border:0;border-radius:10px;background:transparent;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer}.wd-library-picker-trigger:hover{background:var(--dsw-alias-bg-layer-3);color:#eee}.wd-library-picker-trigger .icon{display:grid;place-items:center;width:23px;height:23px;color:currentColor}`;
