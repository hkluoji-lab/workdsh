  ...
  const unregister = connection.fetch.register({
    ...
    fetch: async request => {
      try {
        ...
        const messages: Record<string, string> = { 'library/not-found': '资料不存在或无权访问。', 'library/name-conflict': '同一目录已有同名项目。', 'library/unsupported-format': '当前仅支持 Markdown、TXT、PDF、DOCX 和 PPTX。', 'library/file-size': '文件为空或超过限制。', 'library/cycle': '文件夹不能移动到自己的子目录。', 'library/invalid-name': '资料名称无效。', 'library/revision-conflict': '草稿已被更新，请刷新后重试。', 'library/base-revision-conflict': '正文已有新版本，请重新创建草稿。', 'library/draft-format': '第一版只支持修改 Markdown 和 TXT。', 'library/selection-too-large': '所选目录资料过多，请缩小范围。', 'library/invalid-text': '文本不是有效的 UTF-8。', 'library/invalid-pdf': 'PDF 已损坏或格式与扩展名不符。', 'library/invalid-office-file': 'Office 文件已损坏或格式与扩展名不符。', 'library/invalid-docx': '文件不是有效的 DOCX。', 'library/invalid-pptx': '文件不是有效的 PPTX。', 'library/archive-limit': 'Office 文件解压规模或压缩比超过安全限制。', 'library/archive-path': 'Office 文件包含不安全的归档路径。' };
