...
创建财务或经营分析专家时，读取 material-and-methods 中的分析判断边界，并将相关规则写入方法与边界：算术自洽不能确定单位，已观测子集稳定不能证明总体稳定，缺失不能补零，均值稳定不能证明商品结构稳定。明确区分来源事实、条件计算和待验证假设。发布前的摘要说明材料规则如何映射到定义，不宣称未受管参考已自动挂载。专业试用按 trial-and-delivery 同时核对数值与文字结论，正确JSON不能替代报告评审。
