...
export interface ActivityIdentity { readonly name: string; readonly profession?: string; readonly avatar?: string; readonly kind?: 'assistant' | 'expert' | 'team'; readonly teamName?: string; readonly members?: readonly ActivityIdentity[]; }
