...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Open DSH Terminal to update or remove the failing third-party plugin, then restart WorkDSH.',
    openTerminal: 'Open DSH Terminal',
    restart: 'Restart WorkDSH',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'WorkDSH Update Available',
    updateAvailableMessage: version => `WorkDSH ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside WorkDSH Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'WorkDSH could not check for updates.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'WorkDSH Is Up to Date',
    upToDateMessage: 'No newer version of WorkDSH is available.',
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: 'WorkDSH Update Downloaded',
    updateReady: version => `WorkDSH ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace WorkDSH in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart WorkDSH and run the installer now?',
    ...
    updateInstalled: version => `WorkDSH ${version} has been installed.`,
    ...
    terminalErrorMessage: 'WorkDSH could not open a terminal.',
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: 'WorkDSH could not export the diagnostic archive.',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请打开 DSH 终端更新或移除失败的第三方插件，然后重启 WorkDSH。',
    openTerminal: '打开 DSH 终端',
    restart: '重启 WorkDSH',
    dismiss: '关闭',
    updateAvailableTitle: 'WorkDSH 有可用更新',
    updateAvailableMessage: version => `WorkDSH ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？WorkDSH Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: 'WorkDSH 无法检查更新。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'WorkDSH 已是最新版本',
    upToDateMessage: '当前没有更新版本的 WorkDSH。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: 'WorkDSH 更新已下载',
    updateReady: version => `WorkDSH ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 WorkDSH，然后重新打开。',
    windowsInstallQuestion: '现在重启 WorkDSH 并运行安装程序？',
