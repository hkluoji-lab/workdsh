...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Open DSH Terminal to update or remove the failing third-party plugin, then restart DSH SSH.',
    openTerminal: 'Open DSH Terminal',
    restart: 'Restart DSH SSH',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'DSH SSH Update Available',
    updateAvailableMessage: version => `DSH SSH ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside DSH SSH Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'DSH SSH could not check for updates.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'DSH SSH Is Up to Date',
    upToDateMessage: 'No newer version of DSH SSH is available.',
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: 'DSH SSH Update Downloaded',
    updateReady: version => `DSH SSH ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace DSH SSH in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart DSH SSH and run the installer now?',
    ...
    updateInstalled: version => `DSH SSH ${version} has been installed.`,
    ...
    terminalErrorMessage: 'DSH SSH could not open a terminal.',
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: 'DSH SSH could not export the diagnostic archive.',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请打开 DSH 终端更新或移除失败的第三方插件，然后重启 DSH SSH。',
    openTerminal: '打开 DSH 终端',
    restart: '重启 DSH SSH',
    dismiss: '关闭',
    updateAvailableTitle: 'DSH SSH 有可用更新',
    updateAvailableMessage: version => `DSH SSH ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？DSH SSH Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: 'DSH SSH 无法检查更新。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'DSH SSH 已是最新版本',
    upToDateMessage: '当前没有更新版本的 DSH SSH。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: 'DSH SSH 更新已下载',
    updateReady: version => `DSH SSH ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 DSH SSH，然后重新打开。',
    windowsInstallQuestion: '现在重启 DSH SSH 并运行安装程序？',
