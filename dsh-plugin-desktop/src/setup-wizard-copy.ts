...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    beta: 'Beta',
    title: 'Set up WorkDSH',
    profile: 'Profile',
    welcomeTitle: 'Welcome to WorkDSH',
    ...
    presentationBody: 'Choose how WorkDSH presents the official client.',
    ...
    communityMarketBody: 'The open market built into WorkDSH, including custom data sources.',
    ...
    successBody: 'WorkDSH is ready for this Profile.',
    startUsing: 'Start using WorkDSH',
  ...
  zh: {
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'WorkDSH 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
    ...
    confirmSkip: '确认跳过',
    successTitle: '设置成功',
    successBody: '这个 Profile 的 WorkDSH 已准备就绪。',
    startUsing: '开始使用',
