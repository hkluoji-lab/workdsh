...
await writeFile(join(destination, 'release-manifest.json'), JSON.stringify({
  ...
  sourceCommit,
  harness: '0.1.7-alpha.2',
  node: process.version,
  packageManager: project.packageManager,
  packages,
  verified: [
    'full build and typecheck on Harness 0.1.7-alpha.2',
    ...
    'fresh-profile installation of the nine packages on Harness 0.1.7-alpha.2, authenticated 200 / anonymous 401 checks and Host cold start',
