...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    beta: 'Beta',
    title: 'Set up DSH SSH',
    profile: 'Profile',
    welcomeTitle: 'Welcome to DSH SSH',
    ...
    presentationBody: 'Choose how DSH SSH presents the official client.',
    ...
    communityMarketBody: 'The open market built into DSH SSH, including custom data sources.',
    ...
    successBody: 'DSH SSH is ready for this Profile.',
    startUsing: 'Start using DSH SSH',
  ...
  zh: {
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'DSH SSH 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
    ...
    confirmSkip: '确认跳过',
    successTitle: '设置成功',
    successBody: '这个 Profile 的 DSH SSH 已准备就绪。',
    startUsing: '开始使用',
