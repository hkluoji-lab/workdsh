/** Headless version checks against the public WorkDSH release service. */
...
/** Public endpoint returning the latest WorkDSH version for a requested channel. */
...
export const DESKTOP_CURRENT_VERSION_HEADER = 'X-WorkDSH-Version'

/** Header selecting an isolated Desktop release stream. */
export const DESKTOP_RELEASE_CHANNEL_HEADER = 'X-WorkDSH-Channel'
...
/**
 * Check the fixed WorkDSH version endpoint for a release in one channel.
