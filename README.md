...
| Experts | `workdsh-plugin-experts@0.1.0-alpha.4` | [Expert `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-experts-0.1.0-alpha.4.tgz) · [Release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | Expert definitions and reviewed revisions composed with the official DSH Team runtime. |
| Connectors | `workdsh-plugin-connectors@0.1.0-alpha.1` | [Connector `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-connectors-0.1.0-alpha.1.tgz) · [Project release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | Multiple stdio/HTTP MCP instances, official credential storage, health/tool discovery, and per-conversation tool isolation. |
| Activity | `workdsh-plugin-activity@0.1.0-alpha.3` | [Activity `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-activity-0.1.0-alpha.3.tgz) · [Release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | Visible task, skill, and expert-team activity. |
...
| WorkDSH presentation | `workdsh-bundle@0.1.0-alpha.45` | [Presentation `.tgz`](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-bundle-0.1.0-alpha.45.tgz) · [Project release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) | Optional brand, theme, and workbench composition. Install feature plugins separately. |
...
For the complete product, download every asset from [project release `v0.1.0-alpha.4`](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) into one directory. Stop the target profile, `cd` to that directory, and use the checksum-verifying installer:
...
| 模块 | 安装包版本 | 下载 |
| --- | --- | --- |
| experts | `workdsh-plugin-experts@0.1.0-alpha.4` | [Release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) · [tgz](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-experts-0.1.0-alpha.4.tgz) |
...
| connectors | `workdsh-plugin-connectors@0.1.0-alpha.1` | [Project release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) · [tgz](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-connectors-0.1.0-alpha.1.tgz) |
| activity | `workdsh-plugin-activity@0.1.0-alpha.3` | [Release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) · [tgz](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-plugin-activity-0.1.0-alpha.3.tgz) |
...
| bundle | `workdsh-bundle@0.1.0-alpha.45` | [Project release](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.4) · [tgz](https://github.com/techflag/workdsh/releases/download/v0.1.0-alpha.4/workdsh-bundle-0.1.0-alpha.45.tgz) |
